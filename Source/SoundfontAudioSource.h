...
public:
    ...
    const std::vector<PresetInfo>& getPresets() const
    {
        return PresetInfos;
    }
    ...
    void renderMidiToWav(const juce::String& midiFilePath, const juce::String& wavFilePath, double sampleRate, int blockSize);
    int currentBank = 0;
